  ...
  Widget build(BuildContext context) {
    ...
    return MediReservaPage(title: 'Selecciona una fecha', step: 'Paso 4 de 6', child: Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        IconButton(onPressed: () => setState(() => _month = DateTime(_month.year, _month.month - 1)), icon: const Icon(Icons.chevron_left, size: 20), padding: EdgeInsets.zero, constraints: const BoxConstraints()),
        Text('${names[_month.month - 1]} ${_month.year}', style: const TextStyle(color: kMediText, fontSize: 10.5, fontWeight: FontWeight.bold)),
        IconButton(onPressed: () => setState(() => _month = DateTime(_month.year, _month.month + 1)), icon: const Icon(Icons.chevron_right, size: 20), padding: EdgeInsets.zero, constraints: const BoxConstraints()),
      ]),
