                  ...
                  child: Column(
                    children: [
                      ...
                      const Text('Sistema de Reservas de Consultas Médicas',
                          style: TextStyle(color: kMediMuted, fontSize: 8)),
                      ...
                      Row(
                          ...
                          children: [
                            const Text('¿No tienes cuenta? ',
                                style:
                                    TextStyle(color: kMediMuted, fontSize: 8)),
                            TextButton(
                                onPressed: _busy
                                    ? null
                                    : () => Navigator.push(
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(label,
          style: const TextStyle(
              color: kMediText, fontSize: 8, fontWeight: FontWeight.w600)),
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(icon, size: 16, color: kMediMuted),
          suffixIcon: suffix,
          hintText: label == 'Correo electrónico'
              ? 'ejemplo@correo.com'
              : '••••••••••',
          hintStyle: const TextStyle(fontSize: 8, color: Color(0xFF9AA6B7)),
          isDense: true,
          filled: true,
