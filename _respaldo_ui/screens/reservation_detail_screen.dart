...
class _line extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Container(padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 8), decoration: const BoxDecoration(border: Border(bottom: BorderSide(color: Color(0xFFE9EDF3))),), child: Row(children: [Expanded(child: Text(label, style: const TextStyle(color: kMediMuted, fontSize: 7.5))), if (success) Container(padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3), decoration: BoxDecoration(color: const Color(0xFFDDF5E6), borderRadius: BorderRadius.circular(5)), child: Text(value, style: const TextStyle(color: Color(0xFF138A4A), fontSize: 7.5, fontWeight: FontWeight.bold))) else Flexible(child: Text(value, textAlign: TextAlign.right, style: const TextStyle(color: kMediText, fontSize: 8, fontWeight: FontWeight.w600))) ]));
}
