...
class _ScheduleScreenState extends State<ScheduleScreen> {
    ...
    return MediReservaPage(title: 'Selecciona un horario', step: 'Paso 5 de 6', child: FutureBuilder<List<String>>(
      ...
      builder: (context, snapshot) {
        ...
        return Column(children: [
          Text(dateLabel, textAlign: TextAlign.center, style: const TextStyle(color: kMediText, fontSize: 9.5, fontWeight: FontWeight.bold)),
          ...
          const SizedBox(height: 12),
          const Text('Los horarios mostrados están en tu hora local.', style: TextStyle(color: kMediMuted, fontSize: 7.5)),
  ...
  Widget _message(String text) => Padding(padding: const EdgeInsets.all(25), child: Text(text, textAlign: TextAlign.center, style: const TextStyle(color: kMediMuted, fontSize: 8.5, height: 1.4)));
